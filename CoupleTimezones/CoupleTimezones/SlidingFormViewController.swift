...
class SlidingFormViewController: UIViewController {
    ...
    class func vc(withStoryboardName name: String, bundle: Bundle?, identifier: String, andFormTitle title: String, pages: [SlidingFormPage], currentPageIndex: Int = 0, finishCallback: ((_ results: [Any])->())?) -> SlidingFormViewController {
