...
*/
- (BOOL)loadBankSoundFont:(NSString * _Nonnull)file preset:(NSInteger)preset bank:(NSInteger)bank error:(NSError * _Nullable * _Nullable)error;
/**
  Load a file path
...
*/
- (void)midiCC:(uint8_t)cc value:(uint8_t)value channel:(uint8_t)channel;
/**
  Start a note
*/
- (void)playWithNoteNumber:(uint8_t)noteNumber velocity:(uint8_t)velocity channel:(uint8_t)channel;
...
+ (enum BufferLength)bufferLength;
...
+ (enum BufferLength)recordingBufferLength;
